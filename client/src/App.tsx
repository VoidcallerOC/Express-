...
function Shell({ children }: ShellProps) {
  ...
  return <div className="site-shell">
    {import.meta.env.DEV && <div className="dev-status" role="status"><span>Development preview</span><span>Owner confirmation required for final menu, hours, assets, and ordering destination</span></div>}
